...
if saying + search_lower in gs_companies_lower:
    green_seal = True
    print('Green Seal Certification')
else:
    green_seal = False
...
if search_lower in cn_companies_lower:
    climate_neutral = True
    print('Climate Neutral Certification')
else:
    climate_neutral = False
...
if ra_saying + search_lower + "/" in ra_companies_lower:
    ...
    print('Rainforest Alliance Certification')
else:
...
if search_lower in lb_companies_lower:
    leaping_bunny = True
    print('Leaping Bunny Certification')
else:
    leaping_bunny = False
